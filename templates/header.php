...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm ">
    <a class="navbar-brand" href="<?= in_array($current_page, PAGES) ? 'index.php' : FILE_PATH['home'] ?>"><i
                class="fas fa-book-reader"></i> CookBook
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <?php if (in_array($current_page, ADMIN_PAGES)): // Admin pages ?>
                ...
                <li class="nav-item <?= Helper::activeLink('manage_authors'); ?>">
                    <a class="nav-link"
                       href="<?= FILE_PATH['author'] ?>">Authors <?= Helper::srOnly('manage_authors'); ?></a>
                </li>
                <li class="nav-item <?= Helper::activeLink('manage_categories'); ?>">
                    <a class="nav-link"
                       href="<?= FILE_PATH['category'] ?>">Categories <?= Helper::srOnly('manage_categories'); ?></a>
                </li>
                <li class="nav-item <?= Helper::activeLink('manage_recipe'); ?>">
                    <a class="nav-link"
                       href="<?= FILE_PATH['recipe'] ?>">Recipes <?= Helper::srOnly('manage_recipe'); ?></a>
                </li>
                <li class="nav-item <?= Helper::activeLink('mailing_lists'); ?>">
                    <a class="nav-link"
                       href="<?= FILE_PATH['mail'] ?>">Mailing <?= Helper::srOnly('mailing_lists'); ?></a>
                </li>
            <?php endif; ?>
        </ul>
        ...
        <?= $_SESSION['email'] ?>
            ...
            <li class="nav-item">
                <a class="nav-link"
                   href="<?= in_array($current_page, PAGES) ? 'logout.inc.php' : FILE_PATH['logout'] ?>">Logout</a>
            </li>
